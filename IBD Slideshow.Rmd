...
ggplot( KPNC, aes( x= RACE , y=PREV )) +
  geom_col(     aes( x= factor(RACE, level= c('OTH','WHT','HIS','BLK','ASN')) , y=PREV ), width=0.25, color="darkgrey", fill="green", alpha=0.5 ) +
  geom_segment( aes(  x=RACE, xend= RACE, y=0, yend=PREV), linetype = 'dotted', lwd=0.75, color="#006cc5", alpha=0.5)+
...
.pull-left[
<center><img src="IBD-Slideshow_files/figure-html/loren-oval.jpg" height="500px", width= "400px" /></center>
]

.pull-right[
<!-- <img src="IBD-Slideshow_files/figure-html/kevin-oval.jpg" height="500px", width= "400px" /> -->
<img src="IBD-Slideshow_files/figure-html/blurry-kevin.jpg" height="500px", width= "400px" />
]
