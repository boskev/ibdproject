...
<!-- <img id="object-position-1" src="IBD-Slideshow_files/figure-html/skinny-arrow.png" height="50px",   object-position  /> -->
...
require(kableExtra)
  ...
  kbl(SITES2, booktabs = T, format= "html", 
      ...
      kable_paper(full_width = F, html_font= "Helvetica Neue", "hover", font_size=18) %>% column_spec(1, width = "10cm") %>% 
      column_spec(2:5, "3cm") %>% 
