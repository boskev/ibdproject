...
```
<center><small>On a percentage basis, Children and Seniors were largely excluded from trials in the two main IBD trials categories:  Crohn's Disease & Ulcerative Colitis</small></center>
...
$$E(y) = \beta{x}_{0} + \beta{x}_{1} + \beta{x}_{2} + . . . . \beta{x}_{n} + residuals$$
