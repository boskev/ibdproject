...
output:
  ...
  xaringan::moon_reader: 
    ...
    lib_dir: libs
    css: ["libs/_css/kevin_css.css"]
    
    
---
class: title-slide, bottom, left, inverse, hide-count
background-image: url(libs/_images/cells-unsplash.jpeg)
...
---
layout: true
background-image: url(libs/_images/harvard-bil.png)
...
<center><img src="libs/_images/Rlogo.png" height="350px" /></center>
...
- R provides a wider variety of add-on packages that can enhance prelminary output - <font color="#006cc5">**makes sharing with collaborators fun**</font color>
...
<!-- ![](libs/_images/dsVSpap.png) -->

<center><img src="libs/_images/dsVSpap3.png" height="330px" /></center>

---
class: hide-count, inverse
background-image: url(libs/_images/keyboard-unsplash.jpeg)
background-size: cover
...
Here's area few codes nippets from the  <font color="#006cc5">**dplyr**</font color> and <font color="#006cc5">**broom**</font color> packages that helped clean our data
```{r eval=F}
require(dplyr)
require(broom)  
require(tidyverse)  
...
<center><img src="libs/_images/IBD2-clean.png" height="410px" /></center>
]
...
<!-- # knitr::include_graphics("libs/_images/skinny-arrow.png") -->
<!-- # ``` -->

<center><img src="libs/_images/Kable-summary1.png" height="180px" /></center>
<!-- <img src="libs/_images/skinny-arrow.png" height="50px",  background-position= 0%, 100% /> -->
]
...
background-image: url(libs/_images/codeblue-unsplash.jpeg)
background-size: cover
...
.pull-right[
<center><img src="libs/_images/Kable-summary2.png" height="410px" style="padding-top: 55px" /></center>  ]
]
...
.pull-right[
<center><img src="libs/_images/Kable-summary3.png" height="220px" style="padding-top: 55px"/></center>  ]
]
...
.pull-right[
<center><img src="libs/_images/Kable-summary5.png" height="320px" width="700px" style="padding-top: 25px"/></center>  ]
]
...
<center><img src="libs/_images/kable-summary6.png" height="380px" width=700px" style="padding-top:0px"/></center>  ]

]

.panel[.panel-name[Intl Sites]
.pull-left[
...
.pull-right[
<center><img src="libs/_images/Kable-summary4.png" height="200px" style="padding-top: 55px"/></center>  ]
]
...
require(kableExtra)
  ...
  kbl(SITES2, booktabs = T, format= "html", 
      ...
      kable_material(full_width = F, "hover", font_size=18) %>% column_spec(1, width = "8cm") %>% column_spec(2:5, "3cm") %>% 
      scroll_box(height = "4.25in")
...
---
### <font color="#006cc5">How Was Race/Ethnicty Reported, cont.?</font color>
.pull-left[
```{r echo=F}
library(gt)
...
---
### Racial Composition of IBD Clinical Trials Compared to US Census
...
```{r echo=F}
  ...
  mutate( RACELABEL = str_replace(RACELABEL, "\\n", ' '),
      ...
      kbl( booktabs = T, format= "html",
           ...
           kable_material(full_width = F, "hover") %>% column_spec(1, width = "4cm")  %>% column_spec(2:5, width="1cm")  
```
...
```
<center><small>Women were slightly over-represented, while men were slightly under-represented, relative to census data</small> </center>
...
IBD2 %>% 
   ...
   kbl(booktabs = T, format= "html", linesep='', padding=0,  #<<
       ...
       col.names= linebreak(c("Type of Intervention", #<<
                              "Frequency","Percent"))) %>%  #<<
   kable_material(full_width = F, "hover", #<<
                  font_size=16) %>% #<<
...
<center><img src="libs/_images/Gapminder.gif" height="400px" /></center>
...
.pull-right[
<img src="libs/_images/kevinround.jpg" height="400px" />
]
