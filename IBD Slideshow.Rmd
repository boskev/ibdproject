...
require(kableExtra)
  ...
  kbl(SITES2, booktabs = T, format= "html", 
      ...
      kable_paper(full_width = F, "hover", font_size=18) %>% column_spec(1, width = "8cm") %>% column_spec(2:5, "3cm") %>% 
...
```{r echo=F}
  ...
  mutate( RACELABEL = str_replace(RACELABEL, "\\n", ' '),
      ...
      kbl( booktabs = T, format= "html",
           ...
           kable_paper(full_width = F, "hover") %>% column_spec(1, width = "6cm")  %>% column_spec(2:5, width="2cm")  
```
    ...
    select( CATEGORY, ANALYZED, FEMALES) %>%
      ...
      kbl( booktabs = T, format= "html",
         ...
         col.names = linebreak(c("Category", 
                                 ...
                                 "Female<br>N", 
                                 "Pct<br>Female"))) %>% 
         kable_paper(full_width = F, "hover",  font_size=16) %>% 
                        column_spec(1, width = "6cm") %>% 
                        row_spec( 5, bold=T ) 
```
